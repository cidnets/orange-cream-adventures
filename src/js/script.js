...
// CALENDAR
// This function is now in the global scope to be accessible from other functions.
...
// --- New Helper Function for Mobile ---
// This function generates the large date display for the mobile widget.
...
// This is a simplified version of your calendar function to create the mini-calendar.
function generateMiniCalendar(containerId, year, month) {
    ...
    /*
    // COMMENTED OUT: Create and append day names
    const dayNames = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];
    dayNames.forEach(day => {
        const dayNameCell = document.createElement('div');
        dayNameCell.className = 'mini-day-name';
        dayNameCell.textContent = day;
    ...
    postGrids.forEach(grid => {
        ...
        listItems.forEach(listItem => {
            if (borderStyles.length > 0) {
                ...
                usedColors.push(randomStyle.backgroundColor);
